...
# Busca la clave en st.secrets (Streamlit Cloud o .streamlit/secrets.toml)
# Si no existe, usa una cadena vacía por seguridad.
# ==============================================================================
USDA_API_KEY = st.secrets.get("USDA_API_KEY", "")

# --- BASE DE DATOS LOCAL RÁPIDA (Alimentos cotidianos) ---
ALIMENTOS_CASEROS = [
...
# BÚSQUEDA 2: USDA FoodData Central con API Key desde Secrets
...
with pestana3:
    ...
    if os.path.exists(DATA_FILE):
        df_historial = pd.read_csv(DATA_FILE)
